...
To be notified when a request arrives you need to set a `link:../../groovydoc/io/vertx/groovy/core/http/HttpServer.html#requestHandler((@io.vertx.codegen.annotations.Nullable :: io.vertx.core.Handler))[requestHandler]`:
...
The first way involves providing a `link:../../groovydoc/io/vertx/groovy/core/http/HttpServer.html#websocketHandler((@io.vertx.codegen.annotations.Nullable :: io.vertx.core.Handler))[websocketHandler]`

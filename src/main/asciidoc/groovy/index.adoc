...
`link:../cheatsheet/DeploymentOptions.html#isolatedClasses[isolatedClasses]`-  an entry can be a fully qualified
...
Extra classpath entries can also be provided with `link:../cheatsheet/DeploymentOptions.html#extraClasspath[extraClasspath]` so if

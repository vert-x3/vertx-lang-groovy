...
You can't do much in Vert.x-land unless you can commune with a `link:groovydoc/io/vertx/groovy/core/Vertx.html[null]` object!
...
The `link:../cheatsheet/VertxOptions.html[null]` object has many settings and allows you to configure things like clustering,
...
`link:../cheatsheet/VertxOptions.html[null]` object before creating the Vertx object.
...
It's done by calling `link:groovydoc/io/vertx/groovy/core/Vertx.html#executeBlocking(io.vertx.core.Handler,%20io.vertx.core.Handler)[null]` specifying both the blocking code to execute and a
...
You can deploy a verticle using one of the `link:groovydoc/io/vertx/groovy/core/Vertx.html#deployVerticle(io.vertx.core.Verticle)[null]` method, specifying a verticle
...
The verticle name is used to look up the specific null that will be used to
...
You can also programmatically register and unregister verticle factories using `link:groovydoc/io/vertx/groovy/core/Vertx.html#registerVerticleFactory(io.vertx.core.spi.VerticleFactory)[null]`
and `link:groovydoc/io/vertx/groovy/core/Vertx.html#unregisterVerticleFactory(io.vertx.core.spi.VerticleFactory)[null]` if you wish.
...
Deployments can be undeployed with `link:groovydoc/io/vertx/groovy/core/Vertx.html#undeploy(java.lang.String)[null]`.
...
This configuration is then available via the `link:groovydoc/io/vertx/groovy/core/Context.html[null]` object.
...
If you are embedding Vert.x and you have finished with it, you can call `link:groovydoc/io/vertx/groovy/core/Vertx.html#close()[null]` to close it
down.
...
To set a timer to fire once you use `link:groovydoc/io/vertx/groovy/core/Vertx.html#setTimer(long,%20io.vertx.core.Handler)[null]` method passing in the delay and a handler
...
You can also set a timer to fire periodically by using `link:groovydoc/io/vertx/groovy/core/Vertx.html#setPeriodic(long,%20io.vertx.core.Handler)[null]`.
...
To cancel a periodic timer, call `link:groovydoc/io/vertx/groovy/core/Vertx.html#cancelTimer(long)[null]` specifying the timer id. For example:

...
Coordination of multiple asynchronous results can be achieved with Vert.x `link:../../groovydoc/io/vertx/groovy/core/Future.html[futures]`.
...
The handler returned by `link:../../groovydoc/io/vertx/groovy/core/Future.html#completer()[completer]` completes the future.

`link:../../groovydoc/io/vertx/groovy/core/CompositeFuture.html#any(io.vertx.core.Future,%20io.vertx.core.Future)[CompositeFuture.any]` takes several futures arguments (up to 6) and returns a future that is
...
import io.vertx.groovy.core.Future
import io.vertx.groovy.core.CompositeFuture
def future1 = Future.future()
def future2 = Future.future()
...
`link:../../groovydoc/io/vertx/groovy/core/Future.html#compose(io.vertx.core.Handler,%20io.vertx.core.Future)[compose]` can be used for chaining futures:

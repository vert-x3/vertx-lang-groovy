...
or certain other types that can be copied like `link:groovydoc/io/vertx/groovy/core/buffer/Buffer.html[null]`. In the latter case the key/value
...
You get an instance of `link:groovydoc/io/vertx/groovy/core/shareddata/AsyncMap.html[null]` with
`link:groovydoc/io/vertx/groovy/core/shareddata/SharedData.html#getClusterWideMap(java.lang.String,%20io.vertx.core.Handler)[null]`.
...
You put data in a map with `link:groovydoc/io/vertx/groovy/core/shareddata/AsyncMap.html#put(java.lang.Object,%20java.lang.Object,%20io.vertx.core.Handler)[null]`.
...
You get data from a map with `link:groovydoc/io/vertx/groovy/core/shareddata/AsyncMap.html#get(java.lang.Object,%20io.vertx.core.Handler)[null]`.
...
To obtain a lock use `link:groovydoc/io/vertx/groovy/core/shareddata/SharedData.html#getLock(java.lang.String,%20io.vertx.core.Handler)[null]`.

This won't block, but when the lock is available, the handler will be called with an instance of `link:groovydoc/io/vertx/groovy/core/shareddata/Lock.html[null]`,
signifying that you now own the lock.

While you own the lock no other caller, anywhere on the cluster will be able to obtain the lock.

When you've finished with the lock, you call `link:groovydoc/io/vertx/groovy/core/shareddata/Lock.html#release()[null]` to release it, so
...
You can do this with `link:groovydoc/io/vertx/groovy/core/shareddata/Counter.html[null]`.

You obtain an instance with `link:groovydoc/io/vertx/groovy/core/shareddata/SharedData.html#getCounter(java.lang.String,%20io.vertx.core.Handler)[null]`:

...
This is configured with `link:../cheatsheet/NetClientOptions.html#setReconnectInterval(long)[setReconnectInterval]` and
`link:../cheatsheet/NetClientOptions.html#setReconnectAttempts(int)[setReconnectAttempts]`.
...
SSL/TLS is enabled with  `link:../cheatsheet/NetServerOptions.html#setSsl(boolean)[ssl]`.
...
trust store location is set by using the function `link:../cheatsheet/JksOptions.html#setPath(java.lang.String)[path]` on the
...
`link:../cheatsheet/JksOptions.html#setPath(java.lang.String)[path]` on the
...
longer be trusted. The `link:../cheatsheet/NetClientOptions.html#addCrlPath(java.lang.String)[crlPath]` configures
the crl list to use:

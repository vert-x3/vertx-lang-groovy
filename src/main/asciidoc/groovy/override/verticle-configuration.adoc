...
This configuration is then available via the `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/Context.html[Context]`, The configuration is returned as a Map

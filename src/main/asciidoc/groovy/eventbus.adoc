...
There is a single event bus instance for every Vert.x instance and it is obtained using the method `link:groovydoc/io/vertx/groovy/core/Vertx.html#eventBus()[null]`.
...
This simplest way to register a handler is using `link:groovydoc/io/vertx/groovy/core/eventbus/EventBus.html#consumer(java.lang.String,%20io.vertx.core.Handler)[null]`.
Here's an example:
...
The object returned from call to +consumer()+ is an instance of `link:groovydoc/io/vertx/groovy/core/eventbus/MessageConsumer.html[null]`

This object can subsequently be used to unregister the handler, or use the handler as a stream.

Alternatively you can use `link:groovydoc/io/vertx/groovy/core/eventbus/EventBus.html#consumer(java.lang.String,%20io.vertx.core.Handler)[null]` to
...
To unregister a handler, call `link:groovydoc/io/vertx/groovy/core/eventbus/MessageConsumer.html#unregister()[null]`.

If you are on a clustered event bus, un-registering can take some time to propagate across the nodes, if you want to
be notified when this is complete use `link:groovydoc/io/vertx/groovy/core/eventbus/MessageConsumer.html#unregister(io.vertx.core.Handler)[null]`.
...
Publishing a message is simple. Just use `link:groovydoc/io/vertx/groovy/core/eventbus/EventBus.html#publish(java.lang.String,%20java.lang.Object)[null]` specifying the
...
You can send a message with `link:groovydoc/io/vertx/groovy/core/eventbus/EventBus.html#send(java.lang.String,%20java.lang.Object)[null]`
...
`link:../cheatsheet/DeliveryOptions.html[null]` when sending or publishing:
...
The object you receive in a message handler is a `link:groovydoc/io/vertx/groovy/core/eventbus/Message.html[null]`.

The `link:groovydoc/io/vertx/groovy/core/eventbus/Message.html#body()[null]` of the message corresponds to the object that was sent or published.

The headers of the message are available with `link:groovydoc/io/vertx/groovy/core/eventbus/Message.html#headers()[null]`.
...
When the receiver receives the message they can reply to it by calling `link:groovydoc/io/vertx/groovy/core/eventbus/Message.html#reply(java.lang.Object)[null]`.
...
When sending a message with a reply handler you can specify a timeout in the `link:../cheatsheet/DeliveryOptions.html[null]`.
...
* The recipient has explicitly failed the message using `link:groovydoc/io/vertx/groovy/core/eventbus/Message.html#fail(int,%20java.lang.String)[null]`
...
You should also make sure you have a null implementation on your classpath,

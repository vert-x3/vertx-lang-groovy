...
The `link:groovydoc/io/vertx/groovy/core/VertxOptions.html[VertxOptions]` object has many settings and allows you to configure things like clustering,
...
`link:groovydoc/io/vertx/groovy/core/VertxOptions.html[VertxOptions]` object before creating the Vertx object.
...
If you want to deploy a verticle as a worker verticle you do that with `link:groovydoc/io/vertx/groovy/core/DeploymentOptions.html#setWorker(boolean)[setWorker]`.
...
Extra classpath entries can also be provided with `link:groovydoc/io/vertx/groovy/core/DeploymentOptions.html#setExtraClasspath(java.util.List)[setExtraClasspath]` so they

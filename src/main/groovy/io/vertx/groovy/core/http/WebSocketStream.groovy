...
/**
 * A stream for link WebSocket connection.
 * <p>
 * When the connection attempt is successful, the stream handler is called back with the link
 ...
 * <p>
 * The connection occurs when the link method is called with a non null handler, the other handlers should be

...
public class Pump {
  ...
  public static <T> Pump pump(ReadStream<T> rs, WriteStream<T> ws, int writeQueueMaxSize) {
    def ret = InternalHelper.safeCreate(io.vertx.core.streams.Pump.pump(rs != null ? (io.vertx.core.streams.ReadStream<T>)rs.getDelegate() : null, ws != null ? (io.vertx.core.streams.WriteStream<T>)ws.getDelegate() : null, writeQueueMaxSize), io.vertx.groovy.core.streams.Pump.class);
    return ret;
  }
  /**

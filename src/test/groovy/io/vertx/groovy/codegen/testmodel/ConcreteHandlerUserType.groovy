...
public class ConcreteHandlerUserType implements Handler<RefedInterface1> {
  private final def io.vertx.codegen.testmodel.ConcreteHandlerUserType delegate;
  public ConcreteHandlerUserType(Object delegate) {
    this.delegate = (io.vertx.codegen.testmodel.ConcreteHandlerUserType) delegate;
  }

...
class SuperInterface2Impl implements SuperInterface2 {
  private final def io.vertx.codegen.testmodel.SuperInterface2 delegate;
  public SuperInterface2Impl(Object delegate) {
    this.delegate = (io.vertx.codegen.testmodel.SuperInterface2) delegate;
  }
  public Object getDelegate() {
    return delegate;
  }
